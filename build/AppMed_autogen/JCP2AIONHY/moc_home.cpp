...
QT_MOC_LITERAL(1, 11, 22), // "startInstantSimulation"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 23) // "startRealTimeSimulation"

    },
    "HomeWindow\0startInstantSimulation\0\0"
...
void HomeWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->startInstantSimulation(); break;
        case 1: _t->startRealTimeSimulation(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HomeWindow::startInstantSimulation)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (HomeWindow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HomeWindow::startRealTimeSimulation)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void HomeWindow::startInstantSimulation()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void HomeWindow::startRealTimeSimulation()
{
