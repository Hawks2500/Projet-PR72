...
QT_MOC_LITERAL(1, 17, 13), // "retourAccueil"
QT_MOC_LITERAL(2, 31, 0) // ""

    },
    "SimulationWindow\0retourAccueil\0"
};
...
void SimulationWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SimulationWindow::retourAccueil)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SimulationWindow::retourAccueil()
{
